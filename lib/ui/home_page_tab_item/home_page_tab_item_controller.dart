...
class HomePageTabItemController extends StatefulWidget {
  ...
  @override
  _HomePageTabItemControllerState createState() =>
      _HomePageTabItemControllerState();
}
...
//    await UserApi.getHomepageStatistic(this).then((value) {
...
//    UserApi.getDriverInfo(this).then((value) {
//      setState(() {
//        _driverModel = value;
//      });
//    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          centerTitle: true,
          elevation: 0,
          backgroundColor: Color(0xff307DF4)),
      body: Container(
        child: Column(
          children: <Widget>[
            Container(
              ...
              padding:
                  EdgeInsets.only(top: ScreenUtil().setWidth(225 - 64 * 2)),
            ...
            Expanded(
              ...
              padding: EdgeInsets.fromLTRB(ScreenUtil().setWidth(20),
                  ScreenUtil().setWidth(20), ScreenUtil().setWidth(20), 0),
              itemCount: 2,
